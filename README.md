...
#### 2. Day 2 -- Project 2 [ Simple bill calculator](Project2_simple_bill_calculator.py) <p>Calculating a percentage of a total number,then combining both and splitting the bill</p>
